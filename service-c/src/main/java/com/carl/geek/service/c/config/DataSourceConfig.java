package com.carl.geek.service.c.config;
...
public class DataSourceConfig {
    ...
    @Primary
    @ConfigurationProperties("service-c.datasource.master")
    ...
    @Primary
    @ConfigurationProperties("service-c.datasource.master.configuration")
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDatasource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("com/carl/geek/service/c/dao/mybatis/mappers/*.xml"));
    ...
    public MapperScannerConfigurer masterMapperScannerConfig() {
        ...
        mapperScannerConfigurer.setBasePackage("com.carl.geek.service.c.dao");
