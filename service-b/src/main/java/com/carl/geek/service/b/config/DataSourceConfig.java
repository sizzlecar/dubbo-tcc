package com.carl.geek.service.b.config;
...
public class DataSourceConfig {
    ...
    @Primary
    @ConfigurationProperties("service-b.datasource.master")
    ...
    @Primary
    @ConfigurationProperties("service-b.datasource.master.configuration")
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDatasource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("com/carl/geek/service/b/dao/mybatis/mappers/*.xml"));
    ...
    public MapperScannerConfigurer masterMapperScannerConfig() {
        ...
        mapperScannerConfigurer.setBasePackage("com.carl.geek.service.b.dao");
